...
typedef enum ES { es_newGame, es_newFight, es_attack, es_attackView, es_attackControl, es_attackResult, es_defend, es_defendView, es_defendControl, es_defendResult, es_cmd_quit = 1001, es_cmd_take, es_cmd_wrong, es_cmd_noadd } es;
