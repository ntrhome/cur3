...
typedef enum DUR_STAGE {DUR_STAGE_NEW_MATCH=100, DUR_STAGE_NEW_GAME, DUR_STAGE_NEW_ROUND, DUR_STAGE_ROUND_ATTACK, DUR_STAGE_ROUND_DEFEND, DUR_STAGE_GAME_OVER, DUR_STAGE_QUIT, DUR_STAGE_ERROR} dur_stage;
