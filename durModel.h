...
typedef enum ES { es_newGame, es_newGameView, es_newFight, es_newFightView, es_attack, es_attackView, es_attackControl, es_attackResult, es_attackResultEnoughView, es_defend, es_defendView, es_defendControl, es_defendResult, es_defendResultTookView, es_fightCloseAsDefended, es_fightCloseAsTook, es_cmd_quit = 1001, es_cmd_enough, es_cmd_take, es_cmd_newGame, es_cmd_wrong } es;
